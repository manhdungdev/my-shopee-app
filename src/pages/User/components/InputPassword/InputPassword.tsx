  ...
  return (
    <div>
      <div className='flex items-center gap-5'>
        <span className='w-[30%] shrink-0 text-right'>{children}</span>
        <div className='relative'>
          <input className={className} required {...registerResult} {...rest} type={handleChangeType()} />
          <button type='button' onClick={handleToggleEye} className='absolute right-3 top-1/2 -translate-y-1/2 '>
            {rest.type === 'password' && isOpen && (
